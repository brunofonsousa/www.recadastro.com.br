...
$ult_mat = "SELECT max(MAT_ULTIMA) FROM producao";
$resultult = mysqli_query($conn, $ult_mat);
$resultfim = mysqli_fetch_assoc($resultult);

$ultima_matricula = $resultfim['max(MAT_ULTIMA)'];
...
<?php /*include "atualiza_geral_indicadores.php";*/ ?>
...
<script type="text/javascript">
    ...
    options: {
      ...
      title: {
        display: true,
        text: "PRODUÇÃO GERAL DO SETOR DE RECADASTRO (Total de Indicadores: " + "<?php echo $tot_prod_ind; ?>" + "  -  " + "Última Matrícula: " + "<?php echo $ultima_matricula; ?>" + ")",
      }
    }
  });
</script>
