...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="_css/estilo_principal_um.css">
...
<body id="abre">
  ...
  <div class="first">
      <div class="logo">
        <a href="../principal.php"><img src="_image/logo_recadastro.png" width="300" height="82"></a>
          <nav class="barra">
            <ul>
...
<div class="producao" id="prod_menu">
  ...
  <!-- INDICADORES -->
    ...
    -->
      ...
      <?php include "metamatriculas.php" ?>
      ...
      <div class="tot_dia"><span><?php print_r($total_meta_matriculas); ?></span></div>
...
<script type="text/javascript">
    ...
    function calcular_matriculas() {
      ...
      if (elemResult.textContent === undefined) {
        ...
        var meta_mat = Number("<?php echo $total_meta_matriculas; ?>");
        var s3 = document.getElementById("resultado").innerText;
        if (s3 < meta_mat) {
    ...
    function calcular_atos() {
      ...
      var meta = Number(<'?php echo $total_meta; ?'>);
      if (elemResult.textContent === undefined) {
...
<!-- SEMANAL -->  
  <div class="graficos">
    <div class="graf1">
      <button class="botao_grafico_minha" id="minha" type="button" value="Minha" onclick="myFunction1()">Semanal</button>
    </div>
 ...
 <script>
  function myFunction1() {
    ...
    if (x.style.display === "none") {
        ...
        carregarSemanal('_graficos/semanal_matriculas.php');
...
<div class="seq" id="seq1">
  ...
  <script type="text/javascript">
    ...
    function alertaGeraSequencia() {
        if (confirm("Não esqueça de enviar sua produção antes de emitir sequencia!!!")) {
            } else {
